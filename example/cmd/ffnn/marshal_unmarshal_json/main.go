...
func main() {
	...
	fmt.Println(math.Round(newNet.Calculate([]float64{1, 1})[0]))
	fmt.Println(math.Round(newNet.Calculate([]float64{1, 0})[0]))
	fmt.Println(math.Round(newNet.Calculate([]float64{0, 1})[0]))
	fmt.Println(math.Round(newNet.Calculate([]float64{0, 0})[0]))
}
